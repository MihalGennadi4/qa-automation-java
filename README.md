...
Java com.tcs.edu.Applicationn Building <sup>1 вебинар, 1 неделя</sup>
-------------------------
...
└── src
  └── main
      └── java
          ├── com.tcs.edu.Applicationn.java
          └── com.tcs.edu.printerr.ConsolePrinterr.java
```
- [ ] Build lifecycles: 3
- [ ] Lifecycle phases
- [ ] Plugins
...
Java com.tcs.edu.Applicationn Development <sup>9</sup>
----------------------------
...
### com.tcs.edu.Applicationn overview <sup>0.2</sup>
- [ ] com.tcs.edu.Applicationn architecture
- DB
- backend
- API
- client
...
- [ ] com.tcs.edu.Applicationn testing architecture
- [ ] Test scopes
